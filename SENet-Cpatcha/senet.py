...
#        self.model = self.Build_SEnet(x)
    ...
    def Stem(self, x, scope):
        with tf.name_scope(scope) :
            ...
            split_max_x = Max_pooling(block_1,  padding='SAME')
            split_conv_x = conv_layer(block_1, filter=96, kernel=[3,3], stride=2, padding='SAME', layer_name=scope+'_split_conv1')
...
#            x = Concatenation([split_conv_x, split_max_x])
    ...
    def Inception_resnet_A(self, x, scope):
        with tf.name_scope(scope) :
            ...
            x = conv_layer(x, filter=192, kernel=[1,1], layer_name=scope+'_final_conv1', activation=False)
    ...
    def Inception_resnet_B(self, x, scope):
        with tf.name_scope(scope) :
            ...
            split_conv_x1 = conv_layer(x, filter=72, kernel=[1,1], layer_name=scope+'_split_conv1')

            split_conv_x2 = conv_layer(x, filter=48, kernel=[1,1], layer_name=scope+'_split_conv2')
            split_conv_x2 = conv_layer(split_conv_x2, filter=64, kernel=[1,7], layer_name=scope+'_split_conv3')
            split_conv_x2 = conv_layer(split_conv_x2, filter=72, kernel=[7,1], layer_name=scope+'_split_conv4')

            x = Concatenation([split_conv_x1, split_conv_x2])
            x = conv_layer(x, filter=432, kernel=[1,1], layer_name=scope+'_final_conv1', activation=False)
            # 1154
            x = x * 0.1
            x = init + x
    ...
    def Inception_resnet_C(self, x, scope):
        with tf.name_scope(scope) :
            ...
            split_conv_x2 = conv_layer(x, filter=72, kernel=[1, 1], layer_name=scope + '_split_conv2')
            split_conv_x2 = conv_layer(split_conv_x2, filter=84, kernel=[1, 3], layer_name=scope + '_split_conv3')
            split_conv_x2 = conv_layer(split_conv_x2, filter=96, kernel=[3, 1], layer_name=scope + '_split_conv4')

            x = Concatenation([split_conv_x1,split_conv_x2])
            x = conv_layer(x, filter=804, kernel=[1,1], layer_name=scope+'_final_conv2', activation=False)
            # 2048
            x = x * 0.1
            x = init + x
    ...
    def Reduction_A(self, x, scope):
        with tf.name_scope(scope) :
            ...
            split_max_x = Max_pooling(x, padding='SAME')

            split_conv_x1 = conv_layer(x, filter=n, kernel=[3,3], stride=2, layer_name=scope+'_split_conv1')
            ...
            split_conv_x2 = conv_layer(split_conv_x2, filter=m, kernel=[3,3], stride=2, layer_name=scope+'_split_conv4')
    ...
    def Reduction_B(self, x, scope):
        with tf.name_scope(scope) :
            ...
            split_conv_x1 = conv_layer(x, filter=96, kernel=[1,1], layer_name=scope+'_split_conv1')
            split_conv_x1 = conv_layer(split_conv_x1, filter=144, kernel=[3,3], stride=2, layer_name=scope+'_split_conv2')

            split_conv_x2 = conv_layer(x, filter=96, kernel=[1,1], layer_name=scope+'_split_conv3')
            split_conv_x2 = conv_layer(split_conv_x2, filter=108, kernel=[3,3], stride=2, layer_name=scope+'_split_conv4')

            split_conv_x3 = conv_layer(x, filter=96, kernel=[1,1], layer_name=scope+'_split_conv5')
            split_conv_x3 = conv_layer(split_conv_x3, filter=108, kernel=[3,3], layer_name=scope+'_split_conv6')
            split_conv_x3 = conv_layer(split_conv_x3, filter=120, kernel=[3,3], stride=2, layer_name=scope+'_split_conv7')
...
#        input_x = tf.pad(input_x, [[0, 0], [32, 32], [32, 32], [0, 0]])
        ...
        print 'after Inception_resnet_A', x
        ...
        print 'after Inception_resnet_b', x
        channel = int(np.shape(x)[-1])
        ...
        print 'after Inception_resnet_c', x   
        # channel = int(np.shape(x)[-1])
